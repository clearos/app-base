...
echo infobox_highlight(
    "ClearOS Professional " . $this->session->userdata['os_base_version'],

    "
    <div style='background: url(" . clearos_app_htdocs('base') . "/pro-get-started.png) no-repeat; height:374px; width:670px; margin-left: 15px; margin-top: 15px;'>
    <p style='line-height: 20px; width: 285px; font-size: 13px; position: relative; top: 262px; left: 368px;'>Did you know that ClearCenter offers industry specific solutions to simplify your deployment of ClearOS? Click <a style='color: #e1852e;' href='http://www.clearcenter.com/Solution/solutions.html' target='_blank'>here</a> to learn more or <a style='color: #e1852e;' href='http://www.clearcenter.com/Contact-Us/clearcenter-contact-us-1.html' target='_blank'>talk</a> to one of our solution specialists today.</p>
...
echo "
<p align='center'>" .
    anchor_custom('/app/base/wizard/test/getting_started_community', 'Fake Previous Button') . " " .
    anchor_custom('/app/base/wizard/test/marketplace_community', 'Fake Next Button') . "
</p>
";
