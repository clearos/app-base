...
echo infobox_highlight(
    ...
    "
        <div style='background: url(" . clearos_app_htdocs('base') . "/community-marketplace.png) no-repeat; height:370px; width:674px; margin-left: 15px; margin-top: 15px;'></div>
    
    <!--
    <table cellpadding='7'>
		<tr>
			<td width='50%'>
				<h3>Introducing Marketplace (Community)</h3>
			...
			<td valign='top'>
				...
				<p align='center'>" .  anchor_custom('#', 'Start Marketplace Wizard') . "</p>
			</td>
		</tr>
	</table>
	-->
...
echo "
<p align='center'>" . 
	anchor_custom('/app/base/wizard/test/getting_started_pro', 'Fake Previous Button') . " " .
	anchor_custom('/app/base/wizard/test/marketplace_pro', 'Fake Next Button') . "
</p>
";
